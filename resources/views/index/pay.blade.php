...
<div class="maincont">
    ...
    <div class="dingdanlist">
        <table>
            <tr onClick="window.location.href='/index/addaddress'">
            ...
            <tr>
                ...
                <td>{{$v->address_name}}  {{$v->address_tel}}  {{$v->province}}{{$v->city}}{{$v->area}}{{$v->address_desc}}  {{$v->address_mail}}</td>
                @endforeach
            </tr>
            {{--<tr>--}}
    ...
    $(function () {
        layui.use('layer',function () {
            ...
            $('.jiesuan').click(function () {
                ...
                $.post(
                    "/index/paydo",
                    {goods_id:goods_id,allprice:allprice,_token:'{{csrf_token()}}'},
                    function (res) {
                       if(res.code==6){
